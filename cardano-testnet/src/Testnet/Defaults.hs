...
defaultAlonzoGenesis = do
  ...
  where
    ...
    defaultV3CostModel = Api.CostModel
                           ...
                           , 100, 23000, 100, 23000, 100, 23000, 100, 23000, 100, 23000, 100
                           , 100, 100, 23000, 100, 19537, 32, 175354, 32, 46417, 4, 221973, 511, 0, 1, 89141, 32, 497525
                           , 14068, 4, 2, 196500, 453240, 220, 0, 1, 1, 1000, 28662, 4, 2, 245000, 216773, 62, 1, 1060367
                           , 12586, 1, 208512, 421, 1, 187000, 1000, 52998, 1, 80436, 32, 43249, 32, 1000, 32, 80556, 1
                           , 57667, 4, 1000, 10, 197145, 156, 1, 197145, 156, 1, 204924, 473, 1, 208896, 511, 1, 52467
                           , 32, 64832, 32, 65493, 32, 22558, 32, 16563, 32, 76511, 32, 196500, 453240, 220, 0, 1, 1
                           , 69522 ,11687, 0, 1, 60091, 32, 196500, 453240, 220, 0, 1, 1, 196500, 453240, 220, 0, 1, 1
                           , 1159724, 392670, 0, 2, 806990, 30482, 4, 1927926, 82523, 4, 265318, 0, 4, 0, 85931, 32, 205665
                           , 812, 1, 1, 41182, 32, 212342, 32, 31220, 32, 32696, 32, 43357, 32, 32247, 32, 38314, 32
                           , 35190005, 10, 57996947, 18975, 10, 39121781, 32260, 10, 23000, 100, 23000, 100,  1046420, 18, 3387741, 6, 545063, 1
                           , 66311195, 23097, 18, 292890, 18, 94607019, 87060, 18, 16598737, 18, 2359410, 36, 3973992, 12
                           , 1102635, 1, 204557793, 23271, 36, 307813, 36, 190191402, 85902, 36, 33191512, 36, 388656972
                           , 1, 402099373, 72, 2544991, 72, 1927926, 82523, 4, 117366, 10475, 4   -- taken from plutus-core builtinCostModel.json in the order of PlutusLedgerApi.V3.ParamName
                           ]
